...
public class QAProjectDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        QAProjectGlobalFeatureConfigurator.Configure();
        QAProjectModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<QAProjectDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<QAProjectResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/QAProject");

            options.DefaultResourceType = typeof(QAProjectResource);
        ...
        {
            options.MapCodeNamespace("QAProject", typeof(QAProjectResource));
        });
    }
}
